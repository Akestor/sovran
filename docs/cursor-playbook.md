...
## 5) GDPR / Privacy-by-design requirements
### Non-negotiables
...
## 6) Data layer rules (Postgres is source of truth)
...
## 7) Attachment pipeline (authoritative)
...
## 8) Observability rules (privacy-safe)
...
## 9) Definition of Done (for any PR / Cursor task)
